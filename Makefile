# ====================================================================================
# Setup Project
PROJECT_NAME := provider-argoworkflows
...
XPKGS = provider-argoworkflows
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-argoworkflows: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ArgoWorkflows CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ArgoWorkflows controllers
...
# This target prepares repo for your provider by replacing all "argoworkflows"
